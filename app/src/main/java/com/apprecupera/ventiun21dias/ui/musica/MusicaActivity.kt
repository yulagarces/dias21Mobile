...
class MusicaActivity : AppCompatActivity(), MusicaAdapter.OnItemClickListener {
    ...
    private val canciones = listOf(
        Cancion("1. ", "c1_you_fifty_sounds", "Fifty Sounds", "c1_you_fifty_sounds"),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSiguiente.setOnClickListener {
            if(contador < canciones.size -1){
                contador++
                playSong()
                Toast.makeText(this, "Presioné el botón siguiente "+ contador, Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun playSong(){
        ...
        val nombreCancion = canciones[contador].fileName
